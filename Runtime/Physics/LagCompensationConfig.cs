...
namespace Unity.NetCode
{
    ...
    /// If you wnat to use PhysicsWorldHistory in a prediction system the config must
    ...
    {
        /// <summary>
        /// The number of physics world states that are backed up on the server. This cannot be more than the maximum capacity, leaving it at zero will give oyu the default which is max capacity.
        /// </summary>
