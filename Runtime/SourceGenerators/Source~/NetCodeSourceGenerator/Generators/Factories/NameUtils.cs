...
internal class NameUtils
{
    ...
    internal static void UpdateNameAndNamespace(ref TypeInformation typeInfo, string rootNamespaceForAssembly, ref CodeGenerator.Context codeGenContext, ref INamedTypeSymbol candidateSymbol)
    {
        var uniquePrefix = $"{rootNamespaceForAssembly}";
