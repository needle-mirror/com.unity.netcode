...
namespace Unity.NetCode
{
    ...
    /// <i>as well as a <see cref="SendRpcCommandRequestComponent"/> (which will notify the NetCode system that it exists, and send it)</i>.
    ...
    /// the <see cref="SendRpcCommandRequestComponent"/> request automatically generated.
    /// For example:
    /// <code>
    ...
    /// <para>- A system responsible for consuming the <see cref="SendRpcCommandRequestComponent"/> requests, and queuing
    /// the messages into the <see cref="OutgoingRpcDataStreamBufferComponent"/> stream (for the outgoing connection).
    ...
    /// </para>
    /// <para>
    /// The <see cref="OutgoingRpcDataStreamBufferComponent"/> is processed at the end of the simulation frame by the
    ...
    /// </para>
    /// <para>
    /// <b>To distinguish between a "broadcast" RPC and an "RPC sent to a specific client", see <see cref="SendRpcCommandRequestComponent"/>.</b>
    /// </para>
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// Read-only accessor to retrieve the <see cref="GhostComponent"/> from an entity.
    ...
    public interface IRpcCommandSerializer<T> where T: struct, IComponentData
    {
        ...
        /// <see cref="OutgoingRpcDataStreamBufferComponent"/> (to be sent over the network).
        ...
        /// <summary>
        /// Method called by the <see cref="RpcSystem"/> when an rpc is dequeued from the
        /// <see cref="IncomingRpcDataStreamBufferComponent"/>. Copies the data from the
