...
namespace Unity.NetCode
{
    ...
    /// into the <see cref="OutgoingCommandDataStreamBufferComponent"/>, along with the id of the ghost they
    /// are sent to.</para> /// <para>On the server side, when a command is deserialized from the <see cref="IncomingCommandDataStreamBufferComponent"/>,
    ...
    /// </summary>
    /// <remarks>
    /// To use the AutoCommandTarget, the target entity must have a <see cref="GhostOwnerComponent"/>.
    /// </remarks>
