...
public class LagCompensationTestCubeGhostUpdateSystem : JobComponentSystem
{
    [BurstCompile]
...
#endif
        [ReadOnly] public ArchetypeChunkBufferType<LagCompensationTestCubeSnapshotData> ghostSnapshotDataType;
...
#endif
                LagCompensationTestCubeSnapshotData snapshotData;
...
#pragma warning restore 649
    ...
    protected override void OnCreate()
    {
        ...
        {
            All = new []{
                ComponentType.ReadWrite<LagCompensationTestCubeSnapshotData>(),
        ...
        {
            All = new []{
                ComponentType.ReadOnly<LagCompensationTestCubeSnapshotData>(),
                ComponentType.ReadOnly<GhostComponent>(),
        ...
        RequireForUpdate(GetEntityQuery(ComponentType.ReadWrite<LagCompensationTestCubeSnapshotData>(),
            ComponentType.ReadOnly<GhostComponent>()));
    }
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostSnapshotDataType = GetArchetypeChunkBufferType<LagCompensationTestCubeSnapshotData>(true),
...
public partial class LagCompensationTestCubeGhostSpawnSystem : DefaultGhostSpawnSystem<LagCompensationTestCubeSnapshotData>
{
}
