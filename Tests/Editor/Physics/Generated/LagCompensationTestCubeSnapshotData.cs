...
public struct LagCompensationTestCubeSnapshotData : ISnapshotData<LagCompensationTestCubeSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref LagCompensationTestCubeSnapshotData baseline1, ref LagCompensationTestCubeSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref LagCompensationTestCubeSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref LagCompensationTestCubeSnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref LagCompensationTestCubeSnapshotData target, float factor)
    {
