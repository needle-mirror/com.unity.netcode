...
public struct GhostTypeIndex0TestSnapshotData : ISnapshotData<GhostTypeIndex0TestSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref GhostTypeIndex0TestSnapshotData baseline1, ref GhostTypeIndex0TestSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref GhostTypeIndex0TestSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref GhostTypeIndex0TestSnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref GhostTypeIndex0TestSnapshotData target, float factor)
    {
