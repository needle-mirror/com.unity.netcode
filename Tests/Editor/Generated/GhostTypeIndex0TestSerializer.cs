...
public struct GhostTypeIndex0TestGhostSerializer : IGhostSerializer<GhostTypeIndex0TestSnapshotData>
{
    ...
    public int SnapshotSize => UnsafeUtility.SizeOf<GhostTypeIndex0TestSnapshotData>();
    ...
    public void CopyToSnapshot(ArchetypeChunk chunk, int ent, uint tick, ref GhostTypeIndex0TestSnapshotData snapshot, GhostSerializerState serializerState)
    {
        snapshot.tick = tick;
