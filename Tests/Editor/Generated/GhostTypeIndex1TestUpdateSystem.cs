...
public class GhostTypeIndex1TestGhostUpdateSystem : JobComponentSystem
{
    [BurstCompile]
...
#pragma warning restore 649
#endif
        [ReadOnly] public ArchetypeChunkBufferType<GhostTypeIndex1TestSnapshotData> ghostSnapshotDataType;
        ...
        public void Execute(ArchetypeChunk chunk, int chunkIndex, int firstEntityIndex)
        {
            ...
            for (int entityIndex = 0; entityIndex < ghostEntityArray.Length; ++entityIndex)
            {
                ...
                GhostTypeIndex1TestSnapshotData snapshotData;
...
#pragma warning restore 649
    ...
    protected override void OnCreate()
    {
        ...
        {
            All = new []{
                ComponentType.ReadWrite<GhostTypeIndex1TestSnapshotData>(),
        ...
        {
            All = new []{
                ComponentType.ReadOnly<GhostTypeIndex1TestSnapshotData>(),
                ComponentType.ReadOnly<GhostComponent>(),
        ...
        RequireForUpdate(GetEntityQuery(ComponentType.ReadWrite<GhostTypeIndex1TestSnapshotData>(),
            ComponentType.ReadOnly<GhostComponent>()));
    }
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        ...
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostSnapshotDataType = GetArchetypeChunkBufferType<GhostTypeIndex1TestSnapshotData>(true),
...
public partial class GhostTypeIndex1TestGhostSpawnSystem : DefaultGhostSpawnSystem<GhostTypeIndex1TestSnapshotData>
{
}
