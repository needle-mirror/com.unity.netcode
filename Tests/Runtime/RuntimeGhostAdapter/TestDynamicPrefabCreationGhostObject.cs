...
{
    internal class TestDynamicPrefabCreationGhostObject
    {
        ...
        public async Task TestDynamicPrefabCreationWithSubsceneHelper()
        {
            ...
            var prefab = GhostObjectPrefabHelper.CreateGhostBehaviourPrefab(NetCodeTestWorld.k_GeneratedFolderBasePath, "Empty", typeof(EmptyBehaviour));
            var clone = GameObject.Instantiate(prefab);
            var ghost = clone.GetComponent<GhostObject>();
        ...
        public void TestDynamicPrefabCreationWithSubsceneHelper_Step2()
        {
            ...
            Assert.That(GameObject.FindObjectsByType<GhostObject>(FindObjectsInactive.Include), Is.Empty);
        }
    }
}
