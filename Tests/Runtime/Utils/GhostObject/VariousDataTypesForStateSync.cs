...
namespace Unity.Netcode.Tests
{
    ...
    [Serializable] struct SomeComponent1 : IComponentData { [GhostField] public int someValue; }
    [Serializable] struct SomeComponent2 : IComponentData { [GhostField] public int someValue; }
    [Serializable] struct SomeComponent3 : IComponentData { [GhostField] public int someValue; }
    [Serializable] struct SomeComponent4 : IComponentData { [GhostField] public int someValue; }
    [Serializable] struct SomeComponent5 : IComponentData { [GhostField] public int someValue; }
    [Serializable] struct SomeComponent6 : IComponentData { [GhostField] public int someValue; }
    [Serializable] struct SomeComponent7 : IComponentData { [GhostField] public int someValue; }
    [Serializable] struct SomeComponent8 : IComponentData { [GhostField] public int someValue; }
    [Serializable] struct SomeComponent9 : IComponentData { [GhostField] public int someValue; }
    [Serializable] struct SomeComponent10 : IComponentData { [GhostField] public int someValue; }
    [Serializable] struct SomeComponent11 : IComponentData { [GhostField] public int someValue; }
    [Serializable] struct SomeComponent12 : IComponentData { [GhostField] public int someValue; }
    [Serializable] struct SomeComponent13 : IComponentData { [GhostField] public int someValue; }
    [Serializable] struct SomeComponent14 : IComponentData { [GhostField] public int someValue; }
    [Serializable] struct SomeComponent15 : IComponentData { [GhostField] public int someValue; }
    [Serializable] struct SomeComponent16 : IComponentData { [GhostField] public int someValue; }
    ...
    internal partial class VariousDataTypesForStateSync : GhostBehaviour
    {
        ...
        // public GhostField<GhostObject> ghostLink; // TODO-release
