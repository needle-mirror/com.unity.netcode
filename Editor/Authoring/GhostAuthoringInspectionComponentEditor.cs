...
namespace Unity.Netcode.Editor
{
    ...
    class GhostAuthoringInspectionComponentEditor : UnityEditor.Editor
    {
        ...
        internal void RebuildWindow()
        {
            ...
            // This inspector will grab the already baked prefab for an instance of a GhostObject.
            var isReusedRegisteredPrefab = hasEntitiesForThisGameObject && bakedGameObjectResult.AuthoringRoot.ReusedRegisteredPrefab;
            // Ensure the editor is not editable in these cases.
            var isEditable = hasCachedBakingResult && isPrefabEditable && !isReusedRegisteredPrefab;
