public struct GhostSnapshotData
{
    ...
    {
        return new float4(__GHOST_FIELD_NAME__X * __GHOST_DEQUANTIZE_SCALE__, __GHOST_FIELD_NAME__Y * __GHOST_DEQUANTIZE_SCALE__, __GHOST_FIELD_NAME__Z * __GHOST_DEQUANTIZE_SCALE__, __GHOST_FIELD_NAME__W * __GHOST_DEQUANTIZE_SCALE__);
    }
    ...
    public void Set__GHOST_FIELD_NAME__(float4 val)
    {
        ...
        __GHOST_FIELD_NAME__W = (int)(val.w * __GHOST_QUANTIZE_SCALE__);
    }
    #endregion
